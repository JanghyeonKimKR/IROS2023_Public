...
function resultMat = Get_df_ds_mat(ss)
    ...
    resultMatLeftTop = [ 0,  (1/(Jb/rb^2)+mb)*mb*ss(4)^2,                   0,  df4_ds1;
                   1,   0,                                            0,  df4_ds2;
    ...
    resultMatRightBottom = [ 0,  (1/(Jb/rb^2)+mb)*mb*ss(8)^2,                   0,  df8_ds5;
                       1,   0,                                            0,  df8_ds6;
                       0,  (1/(Jb/rb^2)+mb)*(-mb)*g*cos(deg2rad(ss(7))),  0,  df8_ds7;
                       0,  (1/(Jb/rb^2)+mb)*mb*ss(5)*2*ss(8),             1,  df8_ds8 ];

    resultMat = -eye(8)+ [ resultMatLeftTop, zeros(4,4) ;
                     zeros(4,4), resultMatRightBottom ];
